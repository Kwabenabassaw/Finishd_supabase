...
class Streamingprovider extends StatefulWidget {
 ...
 const Streamingprovider({super.key, required this.showId,required this.title});
...
class _StreamingproviderState extends State<Streamingprovider> {
  ...
  Widget build(BuildContext context) {
    return Container(
      child: FutureBuilder(
        future: trending.fetchStreamingDetails(widget.showId), builder: (context, snapshot) {
